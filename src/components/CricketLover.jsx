        ...
        <div className="w-full py-24 sm:px-5 md:px-48 relative  bg-gradient-to-r from-black via-blue-900 to-black text-white">
            ...
            <h2 className="text-white mt-12 font-semibold text-3xl">
                ...
                <p className="text-base font-medium">
                    ...
                    <br />7. I use firebase authentication system to register user and login.
                    <br />8. In Home page any user can see the available product category.
                    <br />9. Sell can add their product to advertisement. These product will show in the HomePage.
                    <br />10. Sell can add their product to advertisement. These product will show in the HomePage.
                    <br />11. User can check which product seller are authorized by the admin and which are not the authorized person easily. .
                    <br />12. In admin dashboard a admin can easily check all user, all buyer and all seller list and admin can edit and delete these any person easily.
                    <br />13. Admin can make a seller authorized easily .
                    <br />14. As a buyer any user can buy any product from this site.
                    <br />15. As a buyer any user can save a product as a wishlist from this site.
                    <br />16. Here any buy can pay to buy the product in online. Here i user Stipe payment system.
                    <br />16. A seller can easily add a new product to buy.
                    <br />16. In seller dashboard there also all seller product will be show with the current status. Such as sold, Advertised, Advertise.
                    <br />17. In seller dashboard any seller can add any product as advertise team and also show sold if any product have already sold. and also seller can delete their product information.
                    <br />7. I use HTML,CSS,Tailwind,some CSS components, JavaScript, React js, Jwt Token Node js, MondgoDB, stripe for payment etc.
            ...
            <p> HTML,CSS,Tailwind,some CSS components, JavaScript, React js, Node js, MondgoDB, stripe for payment and so on.</p>
            ...
            <button className="flex" onClick={() => handleToLiveLink("https://github.com/S-M-ZUBAYER/Cricket-Lover-client-site")}>
                <p className="my-3 text-blue-600 font-bold text-lg">GitHub Client Site: <span className="font-medium">https://github.com/S-M-ZUBAYER/Cricket-Lover-client-site</span></p>
            </button>
            <button className="flex" onClick={() => handleToLiveLink("https://github.com/S-M-ZUBAYER/Cricket-Lover-server-site")}>
                <p className="my-3 text-blue-600 font-bold text-lg">GitHub Server Site: <span className="font-medium">https://github.com/S-M-ZUBAYER/Cricket-Lover-server-site</span></p>
            </button>
            <h2 className="text-white mt-12 font-semibold text-3xl">
                Gallery:
            </h2>
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
                {mainImg && mainImg.length > 0 && mainImg?.map((perImg, index) => {
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
                {buyerImg && buyerImg.length > 0 && buyerImg?.map((perImg, index) => {
                    return <img key={index} src={perImg} alt="" onClick={() => openImageModal(perImg)} />
                })
                }
            </div>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
                {sellerImg && sellerImg.length > 0 && sellerImg?.map((perImg, index) => {
                    return <img key={index} src={perImg} alt="" onClick={() => openImageModal(perImg)} />
                })
                }
            </div>
