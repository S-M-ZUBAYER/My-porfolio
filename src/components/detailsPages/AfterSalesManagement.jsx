...
//       <p className="my-5">
//         The After Sale Management System (ASMS) website was developed to
//         streamline and optimize the after-sales and warehouse operations of
//         THT-Space Electrical Company Ltd. The primary goals of this website are
//         to enhance inventory management, improve the efficiency of product
//         re-sending, repair, and refund processes, and provide real-time
//         visibility into customer service, warehouse, and financial operations.
//         <br />
//         The development of the ASMS was initiated in response to several
//         challenges, including inaccurate inventory tracking, slow processing of
//         after-sales requests, and inefficient space utilization.
//       </p>
...
//               {CreateUserImg &&
//                 CreateUserImg.length > 0 &&
//                 CreateUserImg?.map((perImg, index) => {
//                   return (
//                     <img
//                       key={index}
//                       src={perImg}
...
//           <div className="mt-3">
//             <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
//               {warehouseUserForShop &&
//                 warehouseUserForShop.length > 0 &&
//                 warehouseUserForShop?.map((perImg, index) => {
//                   return (
//                     <img
//                       key={index}
//                       src={perImg}
...
//         <div className="mt-5">
//           <h3 className="text-xl font-semibold">
//             3. Refund, Resend, Repair Request Edit/Delete
//           </h3>
//           <ul className="ml-5 list-disc">
//             <li>
//               Only admin can edit or delete refund, resend, and repair requests
//               before finance approval.
//             </li>
//           </ul>
//           <div className="mt-3">
//             <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
//               {adminUpdateDeleteRequest &&
//                 adminUpdateDeleteRequest.length > 0 &&
//                 adminUpdateDeleteRequest?.map((perImg, index) => {
//                   return (
//                     <img
//                       key={index}
//                       src={perImg}
...
//             <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
//               {customerServiceTeam &&
//                 customerServiceTeam.length > 0 &&
//                 customerServiceTeam?.map((perImg, index) => {
//                   return (
//                     <img
//                       key={index}
//                       src={perImg}
...
//         <div className="mt-5">
//           <h3 className="text-xl font-semibold">
//             2. Check Request Status and Edit
//           </h3>
//           <ul className="ml-5 list-disc">
...
//           <div className="mt-3">
//             <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
//               {customerServiceCheckUpdate &&
//                 customerServiceCheckUpdate.length > 0 &&
//                 customerServiceCheckUpdate?.map((perImg, index) => {
//                   return (
//                     <img
//                       key={index}
//                       src={perImg}
...
//           <ul className="ml-5 list-disc">
//             <li>
//               First of all, a user needs to log in as a customer service leader.
//             </li>
//             <li>
//               The system will show the requests that need to be approved by the
//               customer service leader.
//             </li>
//             <li>
//               Individually, a customer service leader can check all the
//               information. If all information is correct, the CS leader can
//               approve it for the next procedure.
//             </li>
//             <li>
//               A CS leader can also check and see the current status of every
//               request.
//             </li>
//           </ul>
//           <div className="mt-3">
...
//         <div className="mt-5">
//           <h3 className="text-xl font-semibold">
//             Responsibilities for Particular Warehouse Man
//           </h3>
//           <ul className="ml-5 list-disc">
//             <li>
//               As a warehouse man, the user has responsibility for a specific
//               warehouse.
//             </li>
//             <li>
//               The warehouse man can check and update only the refund, resend,
//               and repair requests for their assigned warehouse.
//             </li>
//             <li>
//               The warehouse man checks all information, including whether the
//               product has been returned to the warehouse.
//             </li>
//             <li>
//               The warehouse man then completes the warehouse-related processes
//               for resend, refund, or repair requests.
//             </li>
//             <li>
//               The warehouse man uploads pictures related to the request. If all
//               processes are complete, they approve the request for the next
//               procedure.
//             </li>
...
//             <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
//               {warehouseMan &&
//                 warehouseMan.length > 0 &&
//                 warehouseMan?.map((perImg, index) => {
//                   return (
//                     <img
//                       key={index}
//                       src={perImg}
...
//         <div className="mt-5">
//           <h3 className="text-xl font-semibold">
//             Responsibilities for Particular Warehouse Manager
//           </h3>
//           <ul className="ml-5 list-disc">
//             <li>
//               First of all, a user needs to log in as a warehouse manager.
//             </li>
//             <li>
//               As a warehouse manager, the user has responsibility for a specific
//               warehouse.
//             </li>
//             <li>
//               Only general requests need to be approved by the warehouse
//               manager. Special requests do not need approval from the warehouse
//               manager.
//             </li>
//             <li>
//               The warehouse manager can check the refund, resend, and repair
//               requests for their assigned warehouse.
//             </li>
//             <li>
//               The warehouse manager checks all information, reviews the
//               processes and pictures provided by the warehouse man, and then
//               approves the request for the finance department.
//             </li>
//           </ul>
//           <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
//             {warehouseManager &&
//               warehouseManager.length > 0 &&
//               warehouseManager?.map((perImg, index) => {
//                 return (
//                   <img
//                     key={index}
//                     src={perImg}
...
//         <div className="mt-5">
//           <h3 className="text-xl font-semibold">
//             Responsibilities of Finance for a Particular Shop
//           </h3>
//           <ul className="ml-5 list-disc">
//             <li>First of all, a user needs to log in as finance.</li>
//             <li>
//               As finance, the user has responsibility for a specific warehouse.
//             </li>
//             <li>
//               Finance can check the refund, resend, and repair requests and also
//               check the current status of all requests.
//             </li>
//             <li>
//               Finance checks all information, reviews the processes and pictures
//               provided by the warehouse man, and then, if a refund or payment is
//               needed, completes the payment procedure. They then get the
//               receipt, upload the receipt and all related images, and approve
//               the request.
//             </li>
//           </ul>
//           <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
...
//       <button
//         className="flex"
//         onClick={() => handleToLiveLink("https://grozziie.zjweiting.com:3086/")}
//       >
//         <p className="my-3 text-blue-600 font-bold text-lg">
//           School Website Live Site:{" "}
//           <span className="font-medium ">
//             https://grozziie.zjweiting.com:3086/
//           </span>
//         </p>
//       </button>
//       <button
...
//         onClick={() =>
//           handleToLiveLink(
//             "https://github.com/S-M-ZUBAYER/THT-Refund-Repair-Resend-Management-System"
//           )
//         }
//       >
//         <p className="my-3 text-blue-600 font-bold text-lg">
...
//         onClick={() =>
//           handleToLiveLink(
//             "https://github.com/S-M-ZUBAYER/THT-Refund-Management-System-clint"
//           )
//         }
//       >
//         <p className="my-3 text-blue-600 font-bold text-lg">
...
//       </h3>
//       <p className="my-5">
//         Email: <span>fengguilin@shininger.com.cn</span>
//       </p>
//       <p className="my-5">
...
import { Link } from "react-router-dom";
import ImageModal from "../SharedPage/ImageModal";
import AfterSalesData from "../../Data/AfterSalesData";
...
const AfterSalesManagement = () => {
  ...
  const handleToLiveLink = (url) => window.open(url, "_blank");
    ...
    <div className="relative w-full py-24 sm:px-5 md:px-48 bg-gradient-to-r from-black via-blue-900 to-black text-white">
      ...
      {AfterSalesData.roles.map((role, i) => (
        <div key={i} className="p-5">
          <h className="text-2xl font-bold text-green-500">{role.name}</h>
      ...
      {AfterSalesData?.account ? (
        <>
          ...
          <p className="my-5">
            Email: <span>{AfterSalesData?.account?.email}</span>
          </p>
          <p className="my-5">
            Password: <span>{AfterSalesData?.account?.password}</span>
          </p>
        </>
      ) : (
        ""
      ...
      {isModalOpen && (
        <ImageModal imgSrc={selectedImage} alt="" onClose={closeImageModal} />
      )}
    </div>
  );
};
