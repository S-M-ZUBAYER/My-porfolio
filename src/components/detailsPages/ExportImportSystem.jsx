...
const ExportImportSystem = () => {
  ...
  return (
    <div className="relative w-full py-24 sm:px-5 md:px-48 bg-gradient-to-r from-black via-blue-900 to-black text-white">
      ...
      <section>
        ...
        <div className="my-10">
          ...
          <ul className="ml-5 list-disc">
            <li>
              Create and Manage Products: Add new products, including brand
              names, product specifications, model, weight, and export quantity.
            </li>
            <li>
            ...
            <li>
              Transportation and Carrier Setup: Define new transportation
              methods for product shipment, add transport countries and ports,
              assign charges for carriers, and set up C&F commission levels.
            </li>
          </ul>
        </div>
        ...
        <div className="my-10">
          ...
          <ul className="ml-5 list-disc">
            <li>
              Review Export Information: Assess and update export details
              entered by the Product Manager.
            </li>
            <li>
              Manage C&F Commission and Charges: Add and manage C&F commission
              levels and carrier charges for different shipments.
            </li>
            <li>
        ...
        <div className="my-10">
          ...
          <ul className="ml-5 list-disc">
            <li>
              Finance Data Entry and Review: Verify all export data for
              accuracy, calculate costs, and complete payment processing.
            </li>
            <li>
              Upload Financial Documents: Attach images or documents to each
              export record as needed.
            </li>
            <li>
              Return for Corrections: Send data back to the export manager for
              corrections if necessary, with comments for improvements.
            </li>
            <li>
              Final Data Review: Finalize verified data for storage and make it
              searchable by keywords for company-wide access.
            </li>
          </ul>
        </div>
      ...
      <section>
        <h2 className="text-white mt-12 font-semibold text-3xl">
          Overall Workflow Steps with Visual Elements
        </h2>
        ...
        <div className="my-10">
          ...
          <p>
            Image: A user account setup screen with options to assign roles
            (Product Manager, Commercial Manager, or Finance).
          </p>
        ...
        <div className="my-10">
          <h3 className="text-lime-300 font-semibold text-2xl">
            Product Setup by Product Manager
          </h3>
          <p>
            Image: Sections for adding products, assigning brands,
            transportation setup, export quantity assignment, and setting
            palletizing details.
          </p>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
            {productManagerImg &&
              productManagerImg.length > 0 &&
              productManagerImg?.map((perImg, index) => {
                return (
                  <img
                    key={index}
                    src={perImg}
        ...
        <div className="my-10">
          <h3 className="text-lime-300 font-semibold text-2xl">
            Export Finalization and Review by Commercial Manager
          </h3>
          <p>
            Image: Review panels with export information for each product,
            including C&F charges, assigned carriers, and approval buttons.
          </p>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
            {commercialManagerImg &&
              commercialManagerImg.length > 0 &&
              commercialManagerImg?.map((perImg, index) => {
                return (
                  <img
                    key={index}
                    src={perImg}
        ...
        <div className="my-10">
          <h3 className="text-lime-300 font-semibold text-2xl">
            Finance Review and Payment Processing
          </h3>
          <p>
            Image: Finance dashboard showing export data with payment
            verification fields, image/document upload options, and
            return-to-export feedback.
          </p>

          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
            {financeImg &&
              financeImg.length > 0 &&
              financeImg?.map((perImg, index) => {
                return (
                  <img
                    key={index}
                    src={perImg}
        ...
        <div className="my-10">
          <h3 className="text-lime-300 font-semibold text-2xl">
            Final Data Access for All Users
          </h3>
          <p>
            Image: A searchable data table accessible to all users, showing
            export records with filters and search functionality.
          </p>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 py-5">
            {finalDataImg &&
              finalDataImg.length > 0 &&
              finalDataImg?.map((perImg, index) => {
                return (
                  <img
                    key={index}
                    src={perImg}
