...
//   const LoginDeviceManagementImgs = [img1, img5]
//   const DashboardImgs = [img2, img3]
//   const EmployeeManagementImgs = [img6, img7, img8, img9]
//   const ResignedEmployeeImgs = [img10, img11]
//   const AttendanceTrackingImgs = [img12, img13, img14,]
//   const SalaryCalculationImgs = [img32, img33, img34,]
//   const PayRulesManagementImgs = [img15,
//     img16,
//     img17]
//   const DeviceListMonitoringImgs = []
//   const AdminManagementImgs = [img4]
//   const LeaveApprovalSystemImgs = [img18]
//   const AttendancePayrollRulesImgs = [img22, img23,
//     img24,
//     img25,
//     img26,
//     img27,
...
//     img30,
//     img31,]
//   const PayPeriodManagementIMgs = [img19,
//     img20,
//     img21]
...
//         </p>
//         <p className="ml-5">
//           3. Displays all attendance devices with detailed information.
//         </p>
//         <p className="ml-5">
//           4. Shows how many employees are connected to each device.
//         </p>
//       </p>

//       <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 px-12 sm:px-0 py-5">
//         {LoginDeviceManagementImgs?.map((perImg, index) => (
//           <img
//             key={index}
//             src={perImg}
//             alt="Authentication"
...
//       <p className="text-base font-medium">
//         <p className="ml-5">
//           5. Displays today’s and date-wise attendance summaries including
//           Total, Present, Absent, Late Punch, and Leave employees.
//         </p>
//         <p className="ml-5">
//           6. Each summary card redirects to its respective details page.
//         </p>
//         <p className="ml-5">
//           7. Notification panel shows leave requests, holiday announcements, and
...
//       <p className="text-base font-medium">
//         <p className="ml-5">
//           8. Displays employee lists with department-wise filtering.
//         </p>
//         <p className="ml-5">
//           9. Admin and HR can update employee information at any time.
//         </p>
//         <p className="ml-5">
//           10. QR codes are generated for each employee to access the Grozziie
//           Attendance App.
//         </p>
//         <p className="ml-5">
//           11. Multiple employee records can be exported to Excel with full
//           details.
//         </p>
//       </p>
//       <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 px-12 sm:px-0 py-5">
...
//       <p className="text-base font-medium">
//         <p className="ml-5">
//           12. Displays all resigned employees with full records.
//         </p>
//         <p className="ml-5">
//           13. Admin and HR can review and update resigned employee information.
//         </p>
//       </p>
//       <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 px-12 sm:px-0 py-5">
//         {ResignedEmployeeImgs?.map((perImg, index) => (
//           <img
//             key={index}
//             src={perImg}
//             alt="Authentication"
...
//       <p className="text-base font-medium">
//         <p className="ml-5">
//           14. Displays All, Present, and Absent attendance sheets by date and
//           date range.
//         </p>
//         <p className="ml-5">
//           15. Admin and HR can export daily or monthly attendance reports for
//           all or selected employees.
//         </p>
//       </p>
//       <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 px-12 sm:px-0 py-5">
//         {AttendanceTrackingImgs?.map((perImg, index) => (
//           <img
//             key={index}
//             src={perImg}
//             alt="Authentication"
...
//       <p className="text-base font-medium">
//         <p className="ml-5">
//           16. Salary calculation page shows employee list with calculation
//           preview option.
//         </p>
//         <p className="ml-5">
//           17. Detailed salary breakdown includes base salary, food allowance,
//           house rent, transport cost, overtime, deductions, penalties, and net
//           payable amount.
//         </p>
//       </p>
//       <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 px-12 sm:px-0 py-5">
//         {SalaryCalculationImgs?.map((perImg, index) => (
//           <img
//             key={index}
//             src={perImg}
//             alt="Authentication"
...
//       <p className="text-base font-medium">
//         <p className="ml-5">
//           18. Admin can edit pay periods and salary rules for one or multiple
//           selected employees for special cases.
//         </p>
//       </p>
//       <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 px-12 sm:px-0 py-5">
//         {PayRulesManagementImgs?.map((perImg, index) => (
//           <img
//             key={index}
//             src={perImg}
//             alt="Authentication"
...
//       </p>
//       <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 px-12 sm:px-0 py-5">
//         {AdminManagementImgs?.map((perImg, index) => (
//           <img
//             key={index}
//             src={perImg}
//             alt="Authentication"
...
//       </p>
//       <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 px-12 sm:px-0 py-5">
//         {LeaveApprovalSystemImgs?.map((perImg, index) => (
//           <img
//             key={index}
//             src={perImg}
//             alt="Authentication"
...
//       </p>
//       <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 px-12 sm:px-0 py-5">
//         {AttendancePayrollRulesImgs?.map((perImg, index) => (
//           <img
//             key={index}
//             src={perImg}
//             alt="Authentication"
...
//       </p>
//       <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 px-12 sm:px-0 py-5">
//         {PayPeriodManagementIMgs?.map((perImg, index) => (
//           <img
//             key={index}
//             src={perImg}
//             alt="Authentication"
...
import FaceAttendanceData from "../../Data/FaceAttendanceData";

const FaceAttendanceManagementSystem = () => {
  return <DetailsPageFormate data={FaceAttendanceData} />;
};
