...
const GrozzieeApp = () => {
  ...
  return (
    <div className="w-full py-24 sm:px-5 md:px-48   bg-gradient-to-r from-black via-blue-900 to-black text-white">
      ...
      <p className="my-5">
        {" "}
        A platform is designed to cater to the needs of customers utilizing
        printers from THT-Space Electrical Company Ltd. Through this
        application, users have the capability to create templates and print
        various documents using Grozziie thermal and dot printers. Additionally,
        users can make purchases directly through the app and access customer
        support via the integrated chat feature....
      </p>
      <h2 className="text-white mt-12 font-semibold text-3xl">
        ...
        <p className="text-base font-medium">
          ...
          <p className="ml-5">
            1. Develop an API to facilitate user registration and login
            functionality for the application.
          </p>

          <span className="font-bold text-green-500">
            *** Product Information & Slider API:
          </span>
          <p className="ml-5">
            2. Implement an API to store diverse product information for display
            in the app, and create an API to showcase distinct images for the
            slider.
          </p>
          ...
          <p className="ml-5">
            3. Create an API to store each widget, enabling the creation and
            presentation of templates in the app interface.
          </p>
          <p className="ml-5">
            4. Incorporate the capability to store background images for
            template creation, and allow the use of emojis from the backend for
            template design.
          </p>

          <span className="font-bold text-green-500">
            *** Instructional Videos & Customer Service API:
          </span>
          <p className="ml-5">
            5. Store and display relevant instructional and relative videos for
            app users.
          </p>
          <p className="ml-5">
            6. Develop backend functionality for user interaction with the
            customer service team in case of any issues.
          </p>

          <span className="font-bold text-green-500">
            *** Product Display & Event-Specific Products API:
          </span>
          <p className="ml-5">
            7. Showcase products available in the mall along with comprehensive
            details for purchase.
          </p>
          <p className="ml-5">
            8. Feature event-specific products on the app, providing information
            for selling and offering discounts based on different festivals and
            occasions.
          </p>

          <span className="font-bold text-green-500">
            *** Purchase Data & Cart Management API:
          </span>
          <p className="ml-5">
            9. Provide APIs for storing purchase data and maintaining user
            shopping carts.
          </p>
          ...
          <p className="ml-5">
            10. Implement an API for the warehouse to display information
            regarding product distribution, available stock, and advertisement
            quantities.
          </p>
          ...
          <p className="ml-5">
            11. Develop an API to store images of different colors for a
            product, allowing for varied product displays.
          </p>

          <span className="font-bold text-green-500">
            *** Product Sorting & Selling API:
          </span>
          <p className="ml-5">
            12. Create APIs for sorting and selling products based on model,
            price, and geographical location.
          </p>

          <span className="font-bold text-green-500">*** Technologies:</span>
          <p className="ml-5">
            13. Technologies employed include Node.js, Express.js, MySQL, and
            others.
          </p>
        </p>
      </h2>
      ...
      <button className="flex">
        <p className="my-3 text-blue-600 font-bold text-lg">
          Goggle Play store link:{" "}
          <span className="font-medium">com.grozziie.printer</span>
        </p>
      </button>
      ...
      >
        <p className="my-3 text-blue-600 font-bold text-lg">
          ...
          <span className="font-medium">
            https://fb.watch/pzpPjVZ-NC/?mibextid=Nif5oz
          </span>
        </p>
      </button>
      ...
      <p className="my-5">
        Email: <span>smzubayer@gmail.com</span>
      </p>
      <p className="my-5">
      ...
      <p className="my-5">
        NB:{" "}
        <span>
          This account don't have the permission to access in the admin access.
        </span>
      </p>
