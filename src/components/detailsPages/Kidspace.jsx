...
const Kidspace = () => {
  ...
  return (
    <div className="w-full py-24 sm:px-5 md:px-48   bg-gradient-to-r from-black via-blue-900 to-black text-white">
      ...
      <p className="my-5">
        In this website any one can find the specific time and activities for
        their child. This is one kind of day care service center website...
      </p>
      <h2 className="text-white font-semibold text-3xl">
        Key Features:
        <p className="text-base font-medium">
          <br />
          1.In this website any one can find the specific time and activities
          for their child..
          <br />
          2.That will be helpful for different kinds of parents.
          <br />
          3.Specially which parents generally busy with their job or other
          activities in maximum day.
          <br />
          4. any one can easily fixed their time and activities which is needed
          for their child.
          <br />
      ...
      <button
        className="flex"
        onClick={() => handleToLiveLink("https://kidspace-3636d.web.app/")}
      >
        <p className="my-3 text-blue-600 font-bold text-lg">
          Live Site:{" "}
          <span className="font-medium ">https://kidspace-3636d.web.app/</span>
        </p>
      </button>
      <button
        className="flex"
        onClick={() =>
          handleToLiveLink("https://github.com/S-M-ZUBAYER/Kidspace-day-care-")
        }
      >
        <p className="my-3 text-blue-600 font-bold text-lg">
          GitHub Client Site:{" "}
          <span className="font-medium ">
            https://github.com/S-M-ZUBAYER/Kidspace-day-care-
          </span>
        </p>
      </button>
      <button
        ...
        onClick={() =>
          handleToLiveLink(
            "https://github.com/S-M-ZUBAYER/kidspace-day-care-server-site"
          )
        }
      >
        <p className="my-3 text-blue-600 font-bold text-lg">
