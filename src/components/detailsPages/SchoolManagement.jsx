...
const SchoolManagement = () => {
  ...
  return (
    <div className=" relative w-full py-24 sm:px-5 md:px-48   bg-gradient-to-r from-black via-blue-900 to-black text-white">
      ...
      <p className="my-5">
        This website is designed to serve both teachers and students, acting as
        a comprehensive digital platform for schools. It streamlines various
        processes, eliminating the need for traditional pen-and-paper methods.
        From student applications to result publication, this website offers a
        wide range of features, making school operations more efficient. One
        significant aspect of this website is its ability to replicate itself
        for different schools with ease. Each school's website operates as a
        distinct and customized platform tailored to that specific institution.
        That's mean a important part of this website that this website can make
        clone website for another school easily. And every school site work as a
        unique site for this particular school. The platform consists of three
        core applications: a school website dedicated to serving students and
        teachers, an admin panel for storing data and facilitating critical
        school operations, and a mobile app designed for teachers. The app
        simplifies tasks such as taking attendance and entering grades, allowing
        teachers to manage their work from the convenience of their homes.
      </p>
      ...
      <p className="text-base font-medium">
        <br /> 1. Schools can display their admission notices, requirements, and
        application processes on this site.
        <br /> 2. Students can apply for admission to the school through this
        website.
        <br /> 3. Applicants can pay their application fees online if required.
        <br /> 4. Admit cards are automatically generated for students if
        ...
        <br /> 7. Students can access and check their term results online if
        ...
        <br /> 10. All students, teachers, and parents can view various school
        activities if uploaded by the school.
        <br /> 11. Parents can share valuable reviews on the site, and users can
        read these reviews. The admin monitors reviews to prevent intentional
        negative feedback.
        <br /> 12. All student results and attendance sheets are accessible. Any
        student and parents can see the student results and attendance list.
        <br /> 13. Schools can update their "About" section and images.
        <br /> 14. Schools can customize slider images for the school website
        home page.
        <br /> 15. The homepage features a news slider for important
        announcements. Anyone can see and check.
        <br /> 16. There's a notice bar for students, parents, and teachers also
        available in this site.
        <br /> 17. Information on the management panel, principal, teachers, and
        staff is available. Any user can see the short description of these
        people.
        <br /> 18. Users can view the academic calendar created by the school.
        <br /> 19. Teachers can access their profiles.
        <br /> 20. Teachers can check their salary status if salary information
        is uploaded.
        <br /> 21. Teachers can submit daily attendance and can write reports
        for emergencies need to leave.
        <br /> 22. Students can check payment status and make payments from this
        site.
        <br /> 23. Students and teachers can submit leave applications.
        <br /> 24. Students can download class routines.
        <br />
        22. This website is a single-page application.
      </p>
      <h3 className=" text-lime-300 mt-4 font-semibold text-xl underline">
        Admin Panel Dashboard:-
      </h3>
      <p className="text-base font-medium">
        <br /> 26. Admin can create student, teacher, and staff ID cards with
        four design categories.
        <br /> 27. ID cards are generated automatically with minimal
        information. Admin inputs some information then the ID card will be
        generated automatically.
        <br /> 28. Admins can post notices on the website.
        <br /> 29. Notices can also be added to the homepage news slider.
        <br /> 30. Admins can update the school's "About" paragraph, banner
        picture, slider images, and more.
        <br /> 31. Admins can add school activities.
        <br /> 32. Academic calendars with event names can be created by using
        this site.
        <br /> 33. Admins can view and search student lists by class, section,
        shift, or name.
        <br /> 34. Teachers can take daily attendance, store records, and send
        SMS notifications for absent students to their parents.
        <br /> 35. Admins can edit or delete student information.
        <br /> 36. Individual student details pages display an overview of
        attendance, payment status, and results.
        <br /> 37. Admins or teachers can add and calculate subject results,
        with grades and averages shown on the main website.
        <br /> 38. Admins can add classes, sections, and shifts.
        <br /> 39. New student information can be added.
        <br /> 40. Yearly costs for each class, section, and shift are easily
        managed. Just add in here. This cost will show individual student
        according to their class name, section name, and shift.
        <br /> 41. Admins can add exam terms and subjects.
        <br /> 42. Admins can create class routines based on class, section, and
        shift.
        <br /> 43. Admins can add admission notices and requirements.
        <br /> 44. Admins can review application lists and applicant profiles.
        <br /> 45. Admins can generate three types of certificates for students:
        transfer, character, and course completion certificates.
        <br /> 46. Admins can manage staff information, lists, and salary
        statuses.
      ...
      <p className="text-base font-medium">
        <br />
        51. Here also have an app for taking student attendance, displaying
        attendance lists.
        <br />
        52. Teachers can input term and subject results from school or home.
        <br />
        53. Results are calculated automatically, including grades and averages.
        <br />
        54. Teachers can take attendance, send SMS notifications to absent
        students' parents.
        <br />
        55. Teachers can view student overviews from the mobile app.
      </p>
