...
const StudyZone = () => {
  ...
  return (
    <div className="w-full py-24 sm:px-5 md:px-48   bg-gradient-to-r from-black via-blue-900 to-black text-white">
      ...
      <p className="my-5">
        This site will help the students to gather knowledge about modern
        technology. Any one can buy any course about modern technology. And
        learn on this particular technology...
      </p>
      <h2 className="text-white font-semibold text-3xl">
        Key Features:
        <p className="text-base font-medium">
          <br />
          1.In this website any one can purchase their different kinds of
          courses.
          <br />
          2.That will be helpful for different ages people gather their
          knowledge from online platform easily.
          <br />
          3.Any one can justify you level to ans this particulars quizzes.
          <br />
          4.This is single page application. To build this site i use react js
          for make user interface..
          <br />
          5. Also i use Node.js to make API. And i use firebase to create
